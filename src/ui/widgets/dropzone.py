...
from src.ui.icons import icon_label, pixmap as icon_pixmap
from src.ui.widgets.common import icon_button
...
class DropZone(QFrame):
    ...
    def __init__(
        ...
        icon_row.addStretch()
        self._icon_label = icon_label("upload-cloud", "#6B7280", 32, weight=1.6)
        ...
        browse_btn = icon_button("Browse files" + (" or folder" if allow_folders else ""), "folder", cls="primary")
        browse_btn.setFixedWidth(210)
    ...
    def dragEnterEvent(self, event) -> None:  # noqa: N802 (Qt override)
        if event.mimeData().hasUrls():
            ...
            self._icon_label.setPixmap(icon_pixmap("upload-cloud", "#FFFFFF", 32, weight=1.6))
    ...
    def _reset_visual(self) -> None:
        self.setProperty("cls", "dropzone")
        self._icon_label.setPixmap(icon_pixmap("upload-cloud", "#6B7280", 32, weight=1.6))
        self.style().unpolish(self)
        self.style().polish(self)
